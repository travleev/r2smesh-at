...
#
set bmargin 6
set label "file name = inventory.gra          run timestamp = 15:45:50 4 August 2014" \
...
plot \
     ...
     "inventory.gra" index   0 using 1:2 title  "Activity (Bq/kg)       " with lines linetype 1 linecolor rgbcolor "red", \
...
set label "file name = inventory.gra          run timestamp = 15:45:50 4 August 2014" \
 at character 1,1 font "Helvetica,8pt"
plot \
     "inventory.gra" index   2 using 1:($2)-($3):($2)+($3)  with filledcurves linecolor rgbcolor "#cbcbcb" notitle, \
     "inventory.gra" index   2 using 1:2 title  "Ingestion Dose (Sv/kg) " with lines linetype 1 linecolor rgbcolor "red", \
     "inventory.gra" index   2 using 1:2:3 with yerrorbars title "Uncertainty" linetype 1 linecolor rgb "black", \
     "inventory.gra" index   3 using 1:2 title "value/t-half for nuclide" pointtype 1 linecolor rgbcolor "forest-green", \
     "inventory.gra" index   3 using (0.8*$1):2:3 with labels notitle textcolor rgbcolor "forest-green" right font "helveticabold,11"
unset label
# pause -1  "Hit return to continue"
